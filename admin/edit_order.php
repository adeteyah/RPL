...
if (isset($_GET['order_id'])) {
    ...
    $o_rate = $_POST['order_rate'];

    $query_update_status = "UPDATE orders SET order_status = ?, order_rate = ? WHERE order_id = ?";

    $stmt_update_status = $conn->prepare($query_update_status);
    $stmt_update_status->bind_param('sii', $o_status, $o_ongkir, $o_id);
                ...
                <div class="col-lg-8 offset-lg-2">
                    <form id="edit-form" method="POST" action="edit_order.php">
                            ...
                            <?php foreach ($orders as $order) { ?>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?php echo $order['order_id']; ?>"
                                            disabled>
                                    </div>
                                    <div class="form-group">
                                        <label>Order Status</label>
                                        <select class="form-control" name="order_status" <?php if ($order['order_status'] == 'delivered')
                                            echo ' disabled'; ?>>
                                    ...
                                    <div class="form-group">
                                        <label>User ID</label>
                                        <input class="form-control" type="text" value="<?php echo $order['user_id']; ?>"
                                            disabled>
                                    </div>
                                    <div class="form-group">
                                        <label>Order Date</label>
                                        <input class="form-control" type="text" value="<?php echo $order['order_date']; ?>"
                                            disabled>
                                    </div>
                                    <div class="form-group">
                                        <label>User Phone</label>
                                        <input class="form-control" type="text" value="<?php echo $order['user_phone']; ?>"
                                            disabled>
                                    </div>
                                    <div class="form-group">
                                        <label>User Address</label>
                                        <input class="form-control" type="text"
                                            value="<?php echo $order['user_address']; ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label>Order Rate</label>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="order_rate" id="rate1"
                                                value="1">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="order_rate" id="rate2"
                                                value="2">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="order_rate" id="rate3"
                                                value="3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="order_rate" id="rate4"
                                                value="4">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="order_rate" id="rate5"
                                                value="5" checked>
                        ...
                        <div class="m-t-20 text-right">
                            ...
                            <button type="submit" class="btn btn-primary submit-btn" name="edit_btn">Update <i
