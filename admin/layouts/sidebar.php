...
<!-- End of Sidebar -->
<!-- Modal -->
<div class="modal fade" id="displayAccount" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-6 col-md-6 text-center">
                        <img src="<?php echo '../assets/img/blog/details/' . $_SESSION['admin_photo2']; ?>" alt=""
                            class="rounded-circle img-responsive" width="150" height="200" />
                    </div>
