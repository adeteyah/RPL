...
$title = "Order Details | MaleFashionApp";
                ...
                <div class="shopping__cart__table">
                                ...
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="img/product/<?= $row['product_image']; ?>" alt="">
                                        </div>
                    ...
                    <?php if ($order_status == 'not paid') { ?>
                        <form method="POST" action="payment.php">
                            ...
                            <input type="submit" name="order_pay_btn" class="btn btn-primary" style="float: right;"
                                value="Pay Now" />
                            <input type="button" onclick="location.href='account.php';" class="btn btn-secondary"
                                style="float: right; margin-right: 15px;" value="Back" />
                        </form>
                    <?php } else { ?>
                        <a href="account.php" class="btn btn-secondary" style="float: right; margin-right: 15px;">Back</a>
                    <?php } ?>
